...
const services = [
  { icon: Users, title: "Mentorat de proximité", desc: "Un référent dédié à chaque jeune, à long terme, pour ne jamais rompre le lien." },
  { icon: BookOpen, title: "Soutien éducatif", desc: "Accompagnement scolaire, salles d'études, ressources pédagogiques adaptées." },
  ...
  { icon: GraduationCap, title: "Orientation & insertion", desc: "Bilans réguliers, conseils, mise en relation avec écoles et entreprises." },
...
const KeparGi = () => (
  <Layout>
    <PageHero
      eyebrow="Kepar gi"
      title="Kepar gi — l'abri où l'on grandit, où l'on revient."
    ...
    <section className="py-16 bg-section-alt">
      <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="font-display text-4xl">Un abri où l'on revient.</h2>
