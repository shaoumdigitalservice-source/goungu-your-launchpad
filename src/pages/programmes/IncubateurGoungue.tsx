  ...
  <Layout>
    ...
    <section className="pb-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-2xl mb-10">
          ...
          <h2 className="font-display text-6xl lg:text-7xl mt-3">Six étapes, un objectif : lancer et durer.</h2>
        </div>
    ...
    <section className="py-16 bg-section-alt">
      <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="font-display text-6xl">Ce que reçoit chaque cohorte.</h2>
