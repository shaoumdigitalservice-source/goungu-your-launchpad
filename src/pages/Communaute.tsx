    ...
    <section className="pb-24">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="font-display text-5xl">Prochains événements</h2>
          ...
          {events.map((e, i) => (
            <article key={i} className="rounded-2xl border bg-card p-7 hover-lift">
              <div className="flex items-center justify-between mb-4">
                <div className="text-4xl font-display text-primary">{e.date}</div>
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="rounded-3xl bg-ink p-10 lg:p-14 flex items-center justify-between flex-wrap gap-6">
          <div>
            ...
            <h2 className="font-display text-5xl">Rejoindre le forum Goungué</h2>
